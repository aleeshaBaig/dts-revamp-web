module SimpleActivityFilterable
  ...
  module ClassMethods
    ...
    def filtering_params(params)
      params.slice(:act_tag, :uc, :department, :io_action, :from, :to, :tag_id, :district_id, :tehsil_id, :user_id, :mobile_user_ids, :multi_department, :larva_type, :username, :status, :datefrom, :dateto, :tehsil_ids, :hotspot_status)
    end
    ...
    def filtering_hotspots_params(params)
      params.slice(:act_tag, :hotspot_district_id, :hotspot_tehsil_id, :hotspot_tag_id, :hotspot_from, :hotspot_to, :uc, :hotspot_status)
    end
