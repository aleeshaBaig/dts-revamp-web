module PatientActivityFilterable
  ...
  module ClassMethods
    ...
    def filtering_params(params)
      params.slice(:patient_tag, :department, :place, :uc, :from, :to, :tehsil_id, :district_id, :tag_id, :act_tag, :patient_id, :provisional_diagnosis, :datefrom, :dateto, :user_id, :tehsil_ids)
    end
